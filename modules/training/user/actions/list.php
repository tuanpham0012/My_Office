    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th class="text-center">Nhắc nhở công việc</th>
                ...
                <?php foreach($users as $key => $user) : ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $user['name'] ?>
                            <br>
                            <span style="font-size: 13px; color: #adadad"><?php echo $user['email'] ?></span>
                        </td>
                        ...
                        <td class="text-center">
                            <a href="index.php?m=user&a=send_mail&id=<?php echo $user['id'] ?>&email=<?php echo $user['email'] ?>">
                                <button class="btn btn-info btn-sm" style="margin-bottom:10px">Gửi email</button>
                            </a>
                        </td>
                        <td class="text-center">
