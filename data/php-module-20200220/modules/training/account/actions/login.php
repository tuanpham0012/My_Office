...
<div class=" col-lg-4 offset-lg-4 mt-4">
    <form class="form-signin text-center" method="post" action="index.php?m=account&a=process_login">
        ...
        <div class="form-group text-left">
            ...
            <input type="email" id="email" name="email" class="form-control" required autofocus value="admin@dcv.vn">
        </div>
        <div class="form-group text-left">
            <label for="password" class="">Mật khẩu:</label>
            <input type="password" id="password" name="password" class="form-control" required value="5e3e6d42f7">
        </div>
